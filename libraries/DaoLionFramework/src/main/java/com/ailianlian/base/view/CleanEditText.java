package com.ailianlian.base.view;
...
import com.ailianlian.base.utils.DimenUtil;
...
public class CleanEditText extends EditText {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null != rightDrawableIcon) {
            touthRightX = getRight() - rightDrawableIcon.getBounds().width() - DimenUtil.dpToPx(getContext(), 12);
        }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        setCompoundDrawablePadding(DimenUtil.dpToPx(getContext(), 12));
